...
file.list.cpg.b = list("cpg.4C_1.mincov10.txt", "cpg.4C_2.mincov10.txt", "cpg.4C_3.mincov10.txt",
                       "cpg.4C11_minus_1.mincov10.txt", "cpg.4C11_minus_2.mincov10.txt", "cpg.4C11_minus_3.mincov10.txt")

# file.list.chg.b = list("chg.4C_1.mincov10.txt", "chg.4C_2.mincov10.txt", "chg.4C_3.mincov10.txt",
#                       "chg.4C11_minus_1.mincov10.txt", "chg.4C11_minus_2.mincov10.txt", "chg.4C11_minus_3.mincov10.txt")

# file.list.chh.b = list("chh.4C_1.mincov10.txt", "chh.4C_2.mincov10.txt", "chh.4C_3.mincov10.txt",
#                       "chh.4C11_minus_1.mincov10.txt", "chh.4C11_minus_2.mincov10.txt", "chh.4C11_minus_3.mincov10.txt")
...
#1 - cpg
myobj.b = methRead(file.list.cpg.b,
               sample.id=list("4C_1","4C_2", "4C_3","4C11_minus_1","4C11_minus_2", "4C11_minus_3"),
               assembly="mm10",
...
#2 - chg
# myobj.chg.b = methRead(file.list.chg,
#                      sample.id=list("4C_1","4C_2", "4C_3", "4C11_minus_1","4C11_minus_2", 
#                                     "4C11_minus_3"),
#                      assembly="mm10",
#                      treatment=c(0,0,0,1,1,1),
#                      context="CpH"
...
#3 - chh
# myobj.chh.b = methRead(file.list.chh,
#                      sample.id=list("4C_1","4C_2", "4C_3", "4C11_minus_1","4C11_minus_2", 
#                               "4C11_minus_3"),
#                      assembly="mm10",
#                      treatment=c(0,0,0,1,1,1),
...
filtered.myobj.b = filterByCoverage(myobj.b, hi.perc = 99.9, save.db = TRUE, dbdir = "filtered")
