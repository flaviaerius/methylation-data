...
prom1000.counts.hyper <- read.table("promoters/cpg3/cpg3_count_prom1000_assocTSS_hyper_c_ovd.txt", header = F)
prom1000.counts.hypo <- read.table("promoters/cpg3/cpg3_count_prom1000_assocTSS_hypo_c_ovd.txt", header = F)
prom500.counts.hyper <- read.table("promoters/cpg3/cpg3_count_prom500_assocTSS_hyper_c_ovd.txt", header = F)
prom500.counts.hypo <- read.table("promoters/cpg3/cpg3_count_prom500_assocTSS_hypo_c_ovd.txt", header = F)
...
write.table(anno3.p500.hyper, "anno_p500_hyper_c.txt", sep = "\t", quote = F, row.names = F, col.names = F)
write.table(anno3.p500.hypo, "anno_p500_hypo_c.txt", sep = "\t", quote = F, row.names = F, col.names = F)

write.table(anno3.p1000.hyper, "anno_p1000_hyper_c.txt", sep = "\t", quote = F, row.names = F, col.names = F)
write.table(anno3.p1000.hypo, "anno_p1000_hypo_c.txt", sep = "\t", quote = F, row.names = F, col.names = F)
