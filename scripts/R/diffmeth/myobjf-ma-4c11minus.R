...
file.list.cpg.f = list("cpg.Ma_1.mincov10.txt", "cpg.Ma_2.mincov10.txt", "cpg.Ma_3.mincov10.txt",
                     "cpg.4C11_minus_1.mincov10.txt",  "cpg.4C11_minus_2.mincov10.txt",  "cpg.4C11_minus_3.mincov10.txt")

# file.list.chg.f = list("chg.Ma_1.mincov10.txt", "chg.Ma_2.mincov10.txt", "chg.Ma_3.mincov10.txt",
#                      "chg.4C11_minus_1.mincov10.txt",  "chg.4C11_minus_2.mincov10.txt",  "chg.4C11_minus_3.mincov10.txt")
# 
# file.list.chh.f = list("chh.Ma_1.mincov10.txt", "chh.Ma_2.mincov10.txt", "chh.Ma_3.mincov10.txt",
...
#1 - cpg
myobj.f = methRead(file.list.cpg.f,
               sample.id=list("Ma_1","Ma_2", "Ma_3", "4C11_minus_1","4C11_minus_2", 
                              "4C11_minus_3"),
               assembly="mm10",
...
#2 - chg
# myobj.chg.f = methRead(file.list.chg,
#                      sample.id=list("Ma_1","Ma_2", "Ma_3", "4C11_minus_1","4C11_minus_2", 
#                                     "4C11_minus_3"),
#                      assembly="mm10",
#                      treatment=c(0,0,0,1,1,1),
...
#3 - chh
# myobj.chh.f = methRead(file.list.chh,
#                      sample.id=list("Ma_1","Ma_2", "Ma_3", "4C11_minus_1","4C11_minus_2", 
#                               "4C11_minus_3"),
#                      assembly="mm10",
#                      treatment=c(0,0,0,1,1,1),
...
filtered.myobj.f = filterByCoverage(myobj.f, hi.perc = 99.9, save.db = TRUE, dbdir = "filtered")
