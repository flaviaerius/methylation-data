...
file.list.cpg.d = list("cpg.Ma_1.mincov10.txt", "cpg.Ma_2.mincov10.txt", "cpg.Ma_3.mincov10.txt",
                     "cpg.4C11_plus_1.mincov10.txt",  "cpg.4C11_plus_2.mincov10.txt",  "cpg.4C11_plus_3.mincov10.txt")

# file.list.chg.d = list("chg.Ma_1.mincov10.txt", "chg.Ma_2.mincov10.txt", "chg.Ma_3.mincov10.txt",
#                    "chg.4C11_plus_1.mincov10.txt",  "chg.4C11_plus_2.mincov10.txt",  "chg.4C11_plus_3.mincov10.txt")
#
# file.list.chh.d = list("chh.Ma_1.mincov10.txt", "chh.Ma_2.mincov10.txt", "chh.Ma_3.mincov10.txt",
...
#1 - cpg
myobj.d = methRead(file.list.cpg.d,
               sample.id=list("Ma_1","Ma_2", "Ma_3", "4C11_plus_1","4C11_plus_2", 
                              "4C11_plus_3"),
               assembly="mm10",
...
#2 - chg
# myobj.chg.d = methRead(file.list.chg,
#                      sample.id=list("Ma_1","Ma_2", "Ma_3", "4C11_plus_1","4C11_plus_2", 
#                                     "4C11_plus_3"),
#                      assembly="mm10",
#                      treatment=c(0,0,0,1,1,1),
...
#3 - chh
# myobj.chh.d = methRead(file.list.chh,
#                      sample.id=list("Ma_1","Ma_2", "Ma_3", "4C11_plus_1","4C11_plus_2", 
#                               "4C11_plus_3"),
#                      assembly="mm10",
#                      treatment=c(0,0,0,1,1,1),
...
filtered.myobj.d = filterByCoverage(myobj.d, hi.perc = 99.9, save.db = TRUE, dbdir = "filtered")
